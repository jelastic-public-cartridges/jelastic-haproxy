...
function _enableSSL(){
        ...
        cat /var/lib/jelastic/SSL/jelastic.crt /var/lib/jelastic/SSL/jelastic-ca.crt /var/lib/jelastic/SSL/jelastic.key >> /var/lib/jelastic/SSL/jelastic.pem;
        ...
        sed -i '/bind .*80/a bind :::443 v4v6 ssl crt /var/lib/jelastic/SSL/jelastic.pem' ${CARTRIDGE_HOME}/versions/$Version/conf/haproxy.conf;
        sed -i '/bind .*80/a bind :::443 v4v6 ssl crt /var/lib/jelastic/SSL/jelastic.pem' ${CARTRIDGE_HOME}/versions/$Version/haproxy.conf.default;
